const Skills = () => {
    const skillCategories = [
        {
            title: 'Languages',
            skills: [ 'Java (Intermediate)', 'Python (Basic)'],
            icon: (
        ...
        {
            title: 'Backend',
            skills: ['Node.js', 'Express.js', 'RESTful API', 'Jest'],
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-2">
                                {category.skills.map((skill, skillIndex) => (
                                    <span
                                        key={skillIndex}
                                        className="px-4 py-2 bg-dark-800 text-dark-200 rounded-lg text-sm font-medium
                             hover:bg-primary-500/20 hover:text-primary-400 hover:border-primary-500/50
                             border border-dark-700 transition-all duration-300 cursor-default"
                                    >
                                        {skill}
                                    </span>
                                ))}
